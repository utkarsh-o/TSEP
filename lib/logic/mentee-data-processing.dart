...
List<FlSpot> getMenteeLessonChartData(DateTime joiningDate) {
  List<FlSpot> result = [];
  Map<int, int> map = {
    1: 0,
    2: 0,
...
List<FlSpot> getMenteeHourChartData(DateTime joiningDate) {
...
List getWeeklyStatistics(List<Schedule> schedule) {
  ...
  return [lectureDuration, lectureCount];
}
